  ...
  return (
    <>
      ...
      {isAddingTag && collapsedWidth && (
        ...
        >
          <span className="text-muted-foreground/70 font-mono font-medium whitespace-nowrap">Add tag</span>
        </div>
      )}
      ...
      <motion.div
        ...
        className={`
          ...
          ${isAddingTag 
            ...
            : 'inline-flex border-muted-foreground/40 hover:border-muted-foreground/60 hover:bg-muted/20 px-2'
          }
        `}
        style={{
          height: '24px',
      ...
      <AnimatePresence mode="wait" initial={false}>
        {isAddingTag ? (
          ...
          <motion.span
            key="add-tag-text"
            className="text-muted-foreground/70 hover:text-muted-foreground font-mono font-medium transition-colors duration-200 whitespace-nowrap"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            transition={{
